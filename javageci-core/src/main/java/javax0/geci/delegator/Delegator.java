...
public class Delegator extends AbstractFilteredFieldsGenerator {
    private static class Config {
         ...
         * -
         *
         * * `{{configVariableName}}` is a filter expression that selects the methods
         ...
         * configuration parameter: `{{configVariableName}}`. The default
         * value for this parameter is `{{configDefaultValue}}`.
         *
         *
         */
