...
2. You should write the test code that creates the fluent API code. This
...
The framework will try to open the `../tools/src/main/java` directory
...
The parameter `method` is the name of the cloner method. The method
