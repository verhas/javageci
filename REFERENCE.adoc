...
manually maintained. This is a very special way. In this case there is
no clear separation between the generated and the manual code. The
generators should only do modifications that take this fact into
account.
