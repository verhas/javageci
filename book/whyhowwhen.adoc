...
purpose and they are good.

1. __Natural,__
2. __Language Intrinsic,__ and
3. __Structural__ are good redundancies, and are not to be managed.
4. **Domain induced** and
5. **Language Evolution** are good candidates for source code generation.
6. __Programmer induced__ must be handled, but with education and not using code generation if possible.
